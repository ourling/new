var GLOBAL_HOME_URL = "http://www.qimiaowa.com";//全景浏览 http://wwww.qimiaowa.com
var GLOBAL_WX_URL = "http://www.qimiaowa.com";//微信全景制作 http://www.qimiaowa.com
var GLOBAL_PANO_URL = "http://make.qimiaowa.com:99";//全景制作 http://make.qimiaowa.com
var GLOBAL_BIM_URL = "http://bim.qimiaowa.com:66";//BIM   http://bim.qimiaowa.com
var GLOBAL_AUTH_URL = "http://auth.qimiaowa.com:88";//权限管理 http://auth.qimiaowa.com
var GLOBAL_STATIC_URL = "..";//静态资源路径
var GLOBAL_HOME_DOMAIN = ".qimiaowa.com";
...
var GLOBAL_QIMIAOWA_VERSION = "v20170801233509";//全局上线版本号，上线时候手工改动
(function (w, d, undefined) {
    ...
    _G.loadCss(GLOBAL_STATIC_URL + '/pluginsCss/zui/zui.min.css?v=' + GLOBAL_QIMIAOWA_VERSION);
    _G.loadCss(GLOBAL_STATIC_URL + '/pluginsCss/zui/zui-theme.css?v=' + GLOBAL_QIMIAOWA_VERSION);
    _G.loadCss(GLOBAL_STATIC_URL + '/pluginsCss/zui/zui.uploader.min.css?v=' + GLOBAL_QIMIAOWA_VERSION);
    _G.loadJs(GLOBAL_STATIC_URL + '/plugins/jq/jquery-1.7.2.js?v=' + GLOBAL_QIMIAOWA_VERSION);
    _G.loadJs(GLOBAL_STATIC_URL + '/plugins/zui/zui.js?v=' + GLOBAL_QIMIAOWA_VERSION);
    _G.loadJs(GLOBAL_STATIC_URL + '/plugins/zui/zui.uploader.js?v=' + GLOBAL_QIMIAOWA_VERSION);
    ...
    _G.loadJs(GLOBAL_STATIC_URL + '/plugins/vue/vue-router.min.js?v=' + GLOBAL_QIMIAOWA_VERSION);
    _G.loadJs(GLOBAL_STATIC_URL + '/js/common/common.js?v=' + GLOBAL_QIMIAOWA_VERSION);
