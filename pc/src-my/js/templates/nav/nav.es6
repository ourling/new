...
let Nav = new Vue({
    ...
    methods: {
        ...
        wx(){
            let appid = 132,secret = 132, code = 465, grant_type = 798;
        ...
        silentLogin() {
            var panoId = queryUrl('id');
            var appId = panoConfig.basic.wxParam.appId;
            window.location.href = 'https://open.weixin.qq.com/connect/oauth2/authorize?appid='
                + appId + '&redirect_uri='
                + GLOBAL_WX_URL + '%2Fwx%2FcheckIsOAuth&response_type=code&scope=snsapi_base&state='
                + appId + ';' + panoId + ';' + ';' + ';' + ';#wechat_redirect';
        }
    }
});
